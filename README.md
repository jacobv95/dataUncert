...
<img src="https://render.githubusercontent.com/render/math?math=\sigma_C =  \left(\frac{\partial C}{\partial A} \sigma_A)^2 + \left(\frac{\partial C}{\partial B} \sigma_B)^2 + 2\frac{\partial C}{\partial A}\frac{\partial C}{\partial B}\sigma_{AB}">
